...
impl Config {
    ...
    pub fn meta_path(&self) -> String {
        self.get_base_path()
            .join(format!("node_{}_meta.json", self.node_id))
            .display()
            .to_string()
    }
    ...
    pub fn wal_path(&self) -> String {
        self.get_base_path()
            .join(format!("node_{}.wal", self.node_id))
            .display()
            .to_string()
    }
    ...
    pub fn snapshot_path(&self) -> String {
        self.get_base_path()
            .join(format!("node_{}_snapshot.json", self.node_id))
            .display()
            .to_string()
    }
    ...
    pub fn min_election_timeout_ms() -> u64 {
        5000
    }
    ...
    pub fn max_election_timeout_ms() -> u64 {
        10000
    }
    ...
    pub fn rpc_request_vote_timeout_ms() -> u64 {
        1000
    }

    /// Max time to wait for a response of AppendEntries RPC.
    pub fn rpc_append_entries_timeout_ms() -> u64 {
        1500
    }
