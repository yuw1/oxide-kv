...
| P8 | Pre-vote, joint consensus, tx timeout, metrics, prod cluster test | 🔄 Active | PR #33-#40 merged; PR #8 (Prometheus + OTel) + PR #9 (3-node smoke test) in flight | Closing the disruptive-server problem + ops hardening |
